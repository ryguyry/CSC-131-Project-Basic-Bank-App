...
public class LoginGUI implements ActionListener, KeyListener {
    ...
    //here is the constructor for our layout
    public LoginGUI() {
        frame = new JFrame();
        panel = new JPanel();       
	...
	public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginButton) {
            if (loginButton.getText().equals("Login")) {
                ...
                username = usernameField.getText().trim();
                // Create an instance of UserRegistration and register the user
                UserRegistration userRegistration = new UserRegistration();
                userRegistration.registerUser(username); // Capture user_id                
